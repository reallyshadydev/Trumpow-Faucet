    ...
    <div className="min-h-screen flex flex-col bg-[#212121] text-white">
      ...
      <section className="mx-auto max-w-2xl text-center mt-12 px-4 text-gray-300 space-y-7">
        ...
        <p className="text-lg leading-relaxed">
          This faucet is entirely funded by the community and you can help add some Trumpows into it to keep us going.
              You can send Trumpows to the address below and it will be reflected in the faucet's balance after at least 6 confirmations.
        </p>
        <div className="my-4">
        ...
        <p className="text-lg leading-relaxed">
            100% of the donations go to the faucet! If you'd like to support the developer you can send some Trumpows or 
